...
from slingshot.config import DB_CONFIG
from slingshot.models import Platform
...
_slingshot_client: Union[DatabricksClient, None] = None
...
def get_default_client() -> DatabricksClient:
    ...
    if not _slingshot_client:
        conf = DB_CONFIG
        _slingshot_client = DatabricksClient(conf.host, conf.token)
