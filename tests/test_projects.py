...
from slingshot.projects import NoSuccessfulSubmissionsFoundError, get_latest_submission_config
...
def test_get_latest_submission_config_success(mock_send, mock_mixed_submissions):
    ...
    with patch("slingshot.api.projects.get_submissions", lambda x: mock_mixed_submissions):
        project_id = "ff10d866-ebf5-46ff-84dc-b5430a5eea45"
...
def test_get_latest_submission_raises_no_successful_submissions_found_error(
    ...
    with patch("slingshot.api.projects.get_submissions", lambda x: mock_no_success_submissions):
        project_id = "ff10d866-ebf5-46ff-84dc-b5430a5eea45"
